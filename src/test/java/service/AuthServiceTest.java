...
import entity.InvalidatedToken;
import entity.User;
import enums.Role;
...
import repository.InvalidatedTokenRepository;
...
public class AuthServiceTest {
    ...
    void testIntrospectValidToken() throws Exception {
        ...
        var introspectResponse = authService.introspect(new dto.request.IntrospectRequest(token));
